...
const technologies = [
    ...
    // { icon: SiMongodb, name: "MongoDB", description: "Base de données NoSQL flexible", category: "back" },
    ...
    // { icon: SiDocker, name: "Docker", description: "Conteneurisation des applications", category: "test" },
    ...
    { icon: SiFirebase, name: "Firebase Hosting", description: "Hébergement web rapide et sécurisé", category: "test" },
    { icon: SiMamp, name: "MAMP", description: "Serveur local PHP/MySQL pour macOS/Windows", category: "test" },
    { icon: SiGithubactions, name: "GitHub Actions", description: "CI/CD intégré à GitHub", category: "test" },
  ...
  return (
    <section className="min-h-screen pt-14 sm:pt-16 lg:pt-20 bg-[#222222] px-6 ">
      <PageTitle>Mes compétences techniques</PageTitle>
      <SectionTitle>Langages de programmation</SectionTitle>
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 mt-4 sm:mt-5 lg:mt-6">
